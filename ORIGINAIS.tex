...
\begin{adjustwidth}{-1.65cm}{}
  ...
  \vspace*{-2.6cm}
  %\hspace{-0.5cm}
  \includegraphics[width=130mm]{./imgs/front.jpg}  
  %\hfill
\end{adjustwidth}
...
\chapter*{I. Infância}
\addcontentsline{toc}{chapter}{\versal{\large{I.}} Infância}
...
\chapter*{II. O novo senhor e a nova senhora}
\addcontentsline{toc}{chapter}{\versal{\large{II.}} O novo senhor e a nova senhora}
...
\chapter*{III. O dia de ano novo dos escravos}
\addcontentsline{toc}{chapter}{\versal{\large{III.}} O dia de ano novo dos escravos}
...
\chapter*{IV. O escravo que ousou se sentir como um homem}
\addcontentsline{toc}{chapter}{\versal{\large{IV.}} O escravo que ousou se sentir como um homem}
\hedramarkboth{ O escravo que ousou se sentir como um homem}{}
...
\chapter*{V. As provações da mocidade}
\addcontentsline{toc}{chapter}{\versal{\large{V.}} As provações da mocidade}
...
\addcontentsline{toc}{chapter}{\versal{\large{VI.}} A senhora ciumenta}
...
\chapter*{VII. O amado}
\addcontentsline{toc}{chapter}{\versal{\large{VII.}} O amado}
...
\chapter*{VIII. O que ensinam os escravos sobre o norte}
\addcontentsline{toc}{chapter}{\versal{\large{VIII.}} O que ensinam os escravos sobre o norte}
\hedramarkboth{ O que ensinam os escravos sobre o norte}{}
...
\chapter*{IX. Retratos de escravistas da vizinhança}
\addcontentsline{toc}{chapter}{\versal{\large{IX.}} Retratos de escravistas da vizinhança}
\hedramarkboth{ Retratos de escravistas da vizinhança}{}
...
\chapter*{X. Uma passagem perigosa na vida da jovem escrava}
\addcontentsline{toc}{chapter}{\versal{\large{X.}} Uma passagem perigosa na vida da jovem escrava}
\hedramarkboth{ Uma passagem perigosa na vida da jovem escrava}{}
...
\chapter*{XI. O novo laço com a vida}
\addcontentsline{toc}{chapter}{\versal{\large{XI.}} O novo laço com a vida}
...
\chapter*{XII. O medo de uma insurreição}
\addcontentsline{toc}{chapter}{\versal{\large{XII.}} O medo de uma insurreição}
...
\chapter*{XIII. A igreja e a escravidão}
\addcontentsline{toc}{chapter}{\versal{\large{XIII.}} A igreja e a escravidão}
...
\chapter*{XIV. Outro laço com a vida}
\addcontentsline{toc}{chapter}{\versal{\large{XIV.}} Outro laço com a vida}
...
\chapter*{XV. A perseguição continua}
\addcontentsline{toc}{chapter}{\versal{\large{XV.}} A perseguição continua}
...
\addcontentsline{toc}{chapter}{\versal{\large{XVI.}} Cenas na fazenda}
...
\chapter*{XVII. A fuga}
\addcontentsline{toc}{chapter}{\versal{\large{XVII.}} A fuga}
...
\addcontentsline{toc}{chapter}{\versal{\large{XVIII.}} Meses de perigo}
...
\chapter*{XIX. Os filhos são vendidos}
\addcontentsline{toc}{chapter}{\versal{\large{XIX.}} Os filhos são vendidos}
...
\addcontentsline{toc}{chapter}{\versal{\large{XX.}} Novos perigos}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXI.}} A brecha do refúgio}
...
\chapter*{XXII. Celebração de Natal}
\addcontentsline{toc}{chapter}{\versal{\large{XXII.}} Celebração de Natal}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXIII.}} Ainda na prisão}
...
\chapter*{XXIV. O candidato ao Congresso}
\addcontentsline{toc}{chapter}{\versal{\large{XXIV.}} O candidato ao Congresso}
...
\chapter*{XXV. Competição de esperteza}
\addcontentsline{toc}{chapter}{\versal{\large{XXV.}} Competição de esperteza}
...
\chapter*{XXVI. Uma era importante na vida do meu irmão}
\addcontentsline{toc}{chapter}{\versal{\large{XXVI.}} Uma era importante na vida do meu irmão}
\hedramarkboth{ Uma era importante na vida do meu irmão}{}
...
\chapter*{XXVII. Um novo destino para os filhos}
\addcontentsline{toc}{chapter}{\versal{\large{XXVII.}} Um novo destino para os filhos}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXVIII.}} Tia Nancy}
...
\chapter*{XXIX. Preparações para a fuga}
\addcontentsline{toc}{chapter}{\versal{\large{XXIX.}} Preparações para a fuga}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXX.}} A caminho do norte}
...
Pântano da Tristeza,\footnote{Great Dismal Swamp, um pântano na Costa
  Leste dos \versal{EUA} que servia de refúgio para escravos fugitivos. Uma das
...
\chapter*{XXXI. Incidentes na Filadélfia}
\addcontentsline{toc}{chapter}{\versal{\large{XXXI.}} Incidentes na Filadélfia}
...
para mim. O lojista disse que seriam tantos levies.\footnote{Contração de ``elevenpence'', o ``levy'' era o real espanhol de um
  oitavo de dólar. [\versal{N.~T.}]} Eu nunca ouvira a palavra antes, mas não o informei
...
\chapter*{XXXII. A reunião entre mãe e filha}
\addcontentsline{toc}{chapter}{\versal{\large{XXXII.}} A reunião entre mãe e filha}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXXIII.}} Um novo lar}
...
\chapter*{XXXIV. O antigo inimigo de volta}
\addcontentsline{toc}{chapter}{\versal{\large{XXXIV.}} O antigo inimigo de volta}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXXV.}} Preconceito de cor}
...
anglo"-saxã, eu não fui colocada em um ``vagão Jim Crow''\footnote{Em geral, ``Jim Crow'' se refere às leis segregacionistas
  ...
  derrogatório para pessoas negras. [\versal{N.~T.}]} a caminho de Rockaway e não fui
...
\addcontentsline{toc}{chapter}{\versal{\large{XXXVI.}} A fuga por um triz}
...
\chapter*{XXXVII. Visita à Inglaterra}
\addcontentsline{toc}{chapter}{\versal{\large{XXXVII.}} Visita à Inglaterra}
...
otimista quanto a ilustre Srta. Murray\footnote{Amelia Matilda Murray (1795--1884), escritora inglesa, autora de
  ...
  de viagens que defende a escravidão americana. [\versal{N.~T.}]} pinta da condição dos
...
\chapter*{XXXVIII. Novos convites para voltar ao sul}
\addcontentsline{toc}{chapter}{\versal{\large{XXXVIII.}} Novos convites para voltar ao sul}
...
\addcontentsline{toc}{chapter}{\versal{\large{XXXIX.}} A confissão}
...
\chapter*{XL. A Lei do Escravo Fugitivo}
\addcontentsline{toc}{chapter}{\versal{\large{XL.}} A Lei do Escravo Fugitivo}
...
\addcontentsline{toc}{chapter}{\large{\versal{XLI.}} \small{Livre afinal}
\medskip}
